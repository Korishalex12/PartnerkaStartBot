    ...
    if text.startswith("/start"):
        kb={"inline_keyboard":[[{"text":f"💳 Купить курс — {STAR_PRICE} ⭐","callback_data":"buy"}],
            ...
            [{"text":"🆘 Поддержка","callback_data":"support"}]]}
                msg(cid,"👋 Привет!\n\n🚀 «Партнёрка с нуля — Первый запуск» — практический мини-курс для новичков.\n\n📚 Ты узнаешь, как выбрать цифровой продукт, получить партнёрскую ссылку, создать предложение и начать продвижение в Telegram.\n\n💳 Стоимость курса — 700 ⭐\n\n⚠️ Курс не обещает гарантированный доход. Результат зависит от твоих действий.",kb)
