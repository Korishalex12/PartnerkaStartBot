...
def handle(u):
    ...
    if text.startswith("/start"):
        ...
        msg(cid,"👋 Привет!\n\n«Партнёрка с нуля — Первый запуск» — практический мини-курс для новичков.\n\nТы разберёшься, как выбрать цифровой продукт, получить партнёрскую ссылку, подготовить предложение, продвигаться в Telegram и считать результат.\n\n⚠️ Курс не обещает гарантированный доход.",kb)
    elif text=="/terms": msg(cid,f"📜 Условия: цифровой PDF. После успешной оплаты курс отправляется автоматически.\n\n{TERMS_URL}")
